...
import { PasscodePanel } from '../../components/fundamental/feedback/passcode-panel/passcode-panel'
    ...
    <>
      ...
      <div className={styles.restaurantRegister}>
        ...
        <div className={styles.footerDiv}>
          <Caption className={styles.caption} color='white' content='* required field' size='m' />
        </div>
      </div>
    </>
  )
